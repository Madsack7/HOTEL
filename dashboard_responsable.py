...
label1 = customtkinter.CTkLabel(master=frame5, text='AW KA HÔTEL', text_color="#4B4745", text_font=("Inter", 40),
                                width=1270, height=90).pack(expand=YES)
...
b1 = customtkinter.CTkButton(master=frame, hover_color="#302D2B", text="Employé", text_font=("Inter", 25),
                             ...
                             corner_radius=20, width=600, height=80, command=employer).place(x=330, y=3)
...
b5 = customtkinter.CTkButton(master=frame, hover_color="#302D2B", text="Chambre", text_font=("Inter", 25),
                             text_color="#FFFFFF", fg_color="#827F7D", border_width=1, border_color="#827F7D",
                             corner_radius=20, width=200, height=80, command=chambre).place(x=1050, y=3)"""

label = customtkinter.CTkLabel(master=fenetre, text="Statistiques", corner_radius=20, fg_color="#4B4745",
                               text_color="#FFFFFF", text_font=("Inter", 20))
label.place(y=240, x=550)

frame1 = customtkinter.CTkFrame(master=fenetre, width=900, corner_radius=20, fg_color="#4B4745", border_color="#FFFFFF",
                                border_width=2, height=450).place(x=190, y=275)
# frame1.grid(row=0, column=0, columnspan=2, rowspan=4, pady=275, padx=190, sticky="nsew")
frame2 = customtkinter.CTkFrame(master=frame1, width=430, fg_color="#827F7D", height=215, border_width=2,
                                border_color="#302D2B", corner_radius=20).place(x=200, y=280)
label2 = customtkinter.CTkLabel(master=frame2, width=350, fg_color="#827F7D", text="Total Chambres",
                                text_color="#FFFFFF", text_font=("Jacques Francois", 30)).place(x=240, y=290)
...
frame3 = customtkinter.CTkFrame(master=frame1, width=430, fg_color="#827F7D", height=215, border_width=2,
                                border_color="#302D2B", corner_radius=20).place(x=200, y=505)
label3 = customtkinter.CTkLabel(master=frame3, width=350, fg_color="#827F7D", text="Total Employés",
                                text_color="#FFFFFF", text_font=("Jacques Francois", 30)).place(x=240, y=515)
...
frame4 = customtkinter.CTkFrame(master=frame1, width=430, fg_color="#827F7D", height=215, border_width=2,
                                border_color="#302D2B", corner_radius=20).place(x=650, y=280)
label4 = customtkinter.CTkLabel(master=frame4, width=350, fg_color="#827F7D", text="Total Salles", text_color="#FFFFFF",
                                text_font=("Jacques Francois", 30)).place(x=690, y=290)
...
frame6 = customtkinter.CTkFrame(master=frame1, width=430, fg_color="#827F7D", height=215, border_width=2,
                                border_color="#302D2B", corner_radius=20).place(x=650, y=505)
label6 = customtkinter.CTkLabel(master=frame6, width=350, fg_color="#827F7D", text="Total Clients",
                                text_color="#FFFFFF", text_font=("Jacques Francois", 30)).place(x=690, y=515)
